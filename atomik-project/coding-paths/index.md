...
| T1 (tooling) | local generation demo — paste text → small model → kernel → rendered scene, in one page over a key-holding local server | [CP-DSL-005](./CP-DSL-005.md) | done (2026-07-07) |
